...
const lightColorSet = {
  ...
  mainThemeForegroundColor: '#BC475A',
...
const imageSet = {
  borderImgSend: require('../assets/images/borderImg1.png'),
  borderImgReceive: require('../assets/images/borderImg2.png'),
  textborderImgSend: require('../assets/images/textBorderImg1.png'),
  textborderImgReceive: require('../assets/images/textBorderImg2.png'),
